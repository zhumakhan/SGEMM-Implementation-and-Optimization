...
int main(int argc, char *argv[]){
    ...
    test(&mmShared, threads, blocks, dA, dB, dC, M, K, N, a_major, b_major, c_major);
    test(&mmSharedRR, threads, blocks, dA, dB, dC, M, K, N, a_major, b_major, c_major);
    test(&mmSharedRC, threads, blocks, dA, dB, dC, M, K, N, a_major, b_major, c_major);
